 ...
 * inputting a String when prompted for an int, playing
 * on a slot that's already been played on, etc.
 */
public class Game
{
    public static void main(String[] args) {
        ...
        player2.setPlayerWins(0);
        
        //The entire program is in a loop because at the end, it asks if the users want to play again
        ...
        while (anotherGame) {
            ...
            while (gameOngoing) {
                ...
                if (validInput) {
                    ...
                    //Printing the Board before executing the loop again
                    System.out.println();
                    Board.Board(s1, s2, s3, s4, s5, s6, s7, s8, s9);
                }
            }
            ...
            if (winner.equals("Player 1")) {
                player1.setPlayerWins(player1.getPlayerWins() + 1);
            } else if (winner.equals("Player 2")) {
                player2.setPlayerWins(player2.getPlayerWins() + 1);
            }
            System.out.println("Game end! Thanks for playing!");
            System.out.println();
            //Asking the users whether or not they want to play again
            boolean notValidInput = true;
            while (notValidInput) {
                System.out.println("Would you like to play again? (Enter Y or N): ");
                String anotherGameOption = input.nextLine();
                //If not, we determine the winner of the most amount of games
                if (anotherGameOption.equals("N")) {
                    if (player1.getPlayerWins() == 1) {
                        System.out.println("Player 1, you had " + player1.getPlayerWins() + " win.");
                    } else {
                        System.out.println("Player 1, you had " + player1.getPlayerWins() + " wins.");
                    }
                    if (player2.getPlayerWins() == 1) {
                        System.out.println("Player 2, you had " + player2.getPlayerWins() + " win.");
                    } else {
                        System.out.println("Player 2, you had " + player2.getPlayerWins() + " wins.");
                    }
                    if (player1.getPlayerWins() > player2.getPlayerWins()) {
                        System.out.println("Player 1, you won the most games. Congrats!");
                    } else if (player2.getPlayerWins() > player1.getPlayerWins()) {
                        System.out.println("Player 2, you won the most games. Congrats!");
                    } else if (player1.getPlayerWins() == player2.getPlayerWins()) {
                        System.out.println("Players 1 and 2, you won the same amount of games. It's a tie!");
                    }
                    anotherGame = false;
                    notValidInput = false;
                } else if (anotherGameOption.equals("Y")) {
                    notValidInput = false;
                } else {
